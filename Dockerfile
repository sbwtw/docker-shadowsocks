...
RUN wget https://github.com/shadowsocks/shadowsocks-rust/releases/download/v1.15.0-alpha.9/shadowsocks-v1.15.0-alpha.9.x86_64-unknown-linux-gnu.tar.xz \
    && wget https://github.com/shadowsocks/v2ray-plugin/releases/download/v1.3.2/v2ray-plugin-linux-amd64-v1.3.2.tar.gz \
    && tar xf v2ray-plugin-linux-amd64-v1.3.2.tar.gz -C / \
    && tar xf shadowsocks-v1.15.0-alpha.9.x86_64-unknown-linux-gnu.tar.xz -C / \
    && rm *.tar.xz *.tar.gz
